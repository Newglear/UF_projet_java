...
public class Main {
    ...
    public static void main(String[] args){
        ...
        } catch (UserNotFoundException | AssignationProblemException | IOException | ConversationAlreadyExists e) {
            e.printStackTrace();
        }

        try {
            conversationManager.getSendData(2).envoyer(new TCPMessage(2,1,"salut bg"));
